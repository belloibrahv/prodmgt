            ...
            <div className="flex flex-wrap gap-1.5 max-w-[160px]">
              {EMOJIS.map((e) => (
                <button
                  ...
                  className={`w-8 h-8 text-lg rounded-8 flex items-center justify-center transition-colors ${emoji === e ? "bg-tva-red-lt ring-2 ring-tva-red" : "bg-tva-surface hover:bg-tva-red-xlt"}`}
                >
                  {e}
                </button>
              ))}
